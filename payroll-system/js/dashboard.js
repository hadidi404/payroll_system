...
// multiple pazyslip generation
  ...
  function loadEditModal(employee_id) {
    fetch(`/payroll-system1/html/edit_employee_html.php?id=${employee_id}`, {
      headers: {
 ...
 function loadEditPayslipModal(payroll_id) {
  fetch(`/payroll-system1/html/edit_payslip_html.php?id=${payroll_id}`, { 
  ...
  function loadAddEmployeeModal() {
    fetch('/payroll-system1/html/add_html.php', {
      headers: {
        'X-Requested-With': 'XMLHttpRequest'
      }
    })
  ...
  function loadPayslipModal(id) {
    fetch(`/payroll-system1/html/payslip_html.php?id=${id}`, {
      headers: {
        'X-Requested-With': 'XMLHttpRequest'
      }
    })
