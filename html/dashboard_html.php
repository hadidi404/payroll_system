      ...
      <tbody>
        <?php while($row = $result1->fetch_assoc()): ?>
          ...
          <tr>
            ...
            <td>
              <a href="delete_payroll.php?employee_id=<?= $row['employee_id'] ?>" class="action-delete-btn" onclick="return confirm('Are you sure you want to delete the payroll details for this employee?');">Delete</a>
            </td>
          </tr>
        <?php endwhile; ?>
      </tbody>
